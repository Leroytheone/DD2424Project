...
networks = {}
net_optim_params = {'optim_type': 'sgd', 'lr': 0.5, 'momentum':0.9, 'weight_decay': 5e-5, 'nesterov': True, 'LUT_lr':[(60, 0.1),(120, 0.02),(160, 0.004),(200, 0.0008)]}
networks['model'] = {'def_file': 'architectures/ResNet34.py', 'pretrained': None, 'opt': net_opt,  'optim_params': net_optim_params} 
